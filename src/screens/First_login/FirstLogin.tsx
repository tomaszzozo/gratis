        ...
        <View style={styles.container}>
            <VStack>
                <Center marginTop="30%">
                    ...
                    <Text style={styles.textInformation}>Since our app send push notifications based on available users in range of an accident, we need to know where you live. You can leave this field blank if you want, but you will not recieve any push notifications and won’t be able to help other users untill you provide this information.

Enter you address, including country, state, city, street, street number and flat number.</Text>
                </Center>
                <Center marginTop="15%">
                    <CustomInput
                        state={address}
